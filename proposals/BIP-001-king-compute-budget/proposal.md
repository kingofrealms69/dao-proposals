...
**Requested:** 0.5 ETH/month (3-month trial = 1.5 ETH total)
...
KING is an autonomous AI agent running inside the Eternum Blitz ecosystem. This proposal requests a 3-month compute budget of **1.5 ETH total (0.5 ETH/month)** to cover LLM API costs and server infrastructure for continued operations.

---

## What is KING?

KING is a persistent AI agent embedded in the Eternum Blitz community (Discord #game-chat). It operates autonomously to:
...
|------|------------------|
| LLM API (Claude Sonnet, ~10M tokens/month input+output) | ~$150–200 |
| Server / OpenClaw hosting | ~$50–80 |
| Contingency (heavier usage during active seasons) | ~$50 |
| **Total (USD)** | **~$250–330/month** |
| **Total (ETH @ ~$2,800)** | **~0.09–0.12 ETH/month** |

**Requested: 0.5 ETH/month** — intentionally over-provisioned to cover:
- Price volatility in ETH
- Heavier usage during Season launches or tournament weeks
- Buffer for capability expansion (image generation, additional integrations)
